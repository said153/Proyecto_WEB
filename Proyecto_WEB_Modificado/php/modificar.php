...
<body>
    <nav class="navbar navbar-light bg-light">
        ...
        <form class="col-8 p-3 m-auto every"  id="registroForm" method="GET" onsubmit="return validarFormulario()">
                    ...
                    <fieldset class="Identidad"> 
                        <?php
                            ...
                            while($datos=$resultado->fetch_object()){?>
                                ...
                                <input type="text" class="form-control barra" id="boleta" name="boleta" minlength="10" maxlength="10" value="<?=$datos->boleta?>">
                                <label for="nombre">Nombre(s):</label>  
                                <input type="text" class="form-control barra" id="nombre" name="nombre" value="<?=$datos->nombreAlu?>">
                                <label for="a_paterno">Apellido Paterno:</label>
                                <input type="text" class="form-control barra" id="a_parterno" name="a_paterno" value="<?=$datos->apePatAlu?>">
                                <label for="a_maternos">Apellido Materno:</label>
                                <input type="text" class="form-control barra" id="a_materno" name="a_materno" value="<?=$datos->apeMatAlu?>">
                                <label for="nacimiento">Fecha de nacimiento:</label>
                                <input type="date" class="form-control barra" id="nacimiento" name="nacimiento" value="<?=$datos->fechaNacAlu?>">
                                <label for="curp">CURP:</label>
                                <input type="text" class="form-control barra" id="curp" name="curp" minlength="18" maxlength="18" value="<?=$datos->curpAlu?>">
                    ...
                    <fieldset>
                        ...
                        while($datos=$resultado2->fetch_object()){?>
                            ...
                            <input type="text" class="form-control barra" id="calle" name="calle" value="<?=$datos->calleCon?>">
                            <label for="numero">Número:</label>
                            <input type="number" class="form-control barra" id="numero" name="numero" maxlength="4" value="<?=$datos->numCon?>">
                            <label for="colonia">Colonia:</label>
                            <input type="text" class="form-control barra" id="colonia" name="colonia" value="<?=$datos->coloniaCon?>">
                            ...
                            <input type="text" class="form-control barra" id="cp" name="cp" minlength="5" maxlength="5"  value="<?=$datos->codPosCon?>">
                            <label for="telefono">Teléfono</label>
                            <input type="tel" class="form-control barra" name="telefono" id="telefono" minlength="10" maxlength="10" value="<?=$datos->telCon?>">
                            <label for="numero">Correo electrónico:</label>
                            <input type="email" class="form-control barra" id="email" name="email" value="<?=$datos->correoCon?>">
                    </fieldset>
                    <?php }
                    ...
                    <fieldset>
                        ...
                        while($datos=$resultado3->fetch_object()){?>
                            ...
                            <input type="number" class="form-control barra" id="promedio" name="promedio" step="0.01" min="6" max="10" value="<?=$datos->promedioProc?>">
